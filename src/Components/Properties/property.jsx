...
export const PropertyComp = ({showbid, showtimer,
  startcount}) => {
        ...
        >
          <div className="shadow p-4 rounded-lg bg-white">
            <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
              ...
              {showbid && <span className="absolute top-0 right-1 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-gradient-to-r from-blue-600 to-cyan-500 text-sm font-medium text-white select-none">
                Bid On Listing
              </span>}
              {showtimer && <span className="absolute top-0 right-1 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-gradient-to-r from-blue-600 to-cyan-500 text-sm font-medium text-red-500 select-none">
              <CountdownTimer initialTimeInSeconds={6000} />
              </span>}
              {startcount && <span className="absolute top-0 right-1 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-gradient-to-r from-blue-600 to-cyan-500 text-sm font-medium text-white select-none">
                Start CountDown
              </span>}
