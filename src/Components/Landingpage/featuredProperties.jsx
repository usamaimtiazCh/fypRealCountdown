  ...
  return (
    <div className="my-10 px-10">
      <div className="flex flex-col justify-center items-center py-5">
        <h1 className="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-center  lg:w-auto lg:text-left  dark:text-white text-[3rem]">
          Featured Properties
        </h1>
        <div className="w-1/5 h-1 rounded-xl bg-blue-900 mt-2 "></div>
      </div>
              ...
              <div className="grid grid-cols-2 mt-8">
                <div className="flex items-center">
                  <div className="relative">
                    <Avatar src="https://images.pexels.com/photos/415263/pexels-photo-415263.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" />
                  </div>
